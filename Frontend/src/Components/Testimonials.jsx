    ...
    <div style={{ backgroundColor: "#F5EDED" }}>
      <div className="container my-5 ">
        ...
        {/* <motion.div
          ...
          style={{ display: "flex", overflow: "hidden", whiteSpace: "nowrap" }} // Ensures sliding works properly
        ...
        > */}
          {/* First Card */}
          <div className="col-md-4 mb-4 m-2 " style={{ display: "inline-block", width: "30%" }}>
